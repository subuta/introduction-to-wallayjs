...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelloComponent = function HelloComponent(element) {
	    _classCallCheck(this, HelloComponent);

	    (0, _jquery2.default)(element).addClass('l-hello-console');
	    (0, _jquery2.default)(element).addClass('l-hello-centered');
	    (0, _jquery2.default)(element).append('<span id="console-prefix">$&nbsp;</span><span>hello</span>');
	};
